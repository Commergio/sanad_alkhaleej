...
export const orders: Order[] = [
  {
    ...
    distanceKm: 8.4,
    etaMinutes: 22,
    notes: "التسليم عند الاستقبال — الطابق الثاني",
  },
  {
    id: "ord-2",
  ...
  },
  {
    ...
    distanceKm: 12.1,
    etaMinutes: 35,
    notes: "تسليم عبر بوابة الموردين",
  },
  {
    id: "ord-4",
  ...
  {
    id: "ord-6",
    orderNumber: "SK-712456",
    customerId: "cust-1",
    customerName: "عيادة العتيبي لطب الأسنان",
    customerType: "clinic",
    doctorName: "د. أحمد العتيبي",
    city: "الرياض",
    phone: "0501234567",
    ...
    items: [
      { productId: "prod-6", productName: "Surgical Mask Type IIR", quantity: 5, price: 35, sku: "MSK-IIR-50" },
      { productId: "prod-4", productName: "Dental Gloves Nitrile Medium", quantity: 4, price: 65, sku: "GLV-NIT-M-100" },
    ],
    total: 435,
    status: "picked_up",
    ...
    deliveryAgentId: "agent-2",
    deliveryAgentName: "خالد الدوسري",
    estimatedDelivery: "2026-06-29T11:30:00",
    deliveryMethod: "express",
    distanceKm: 5.2,
    etaMinutes: 18,
    notes: "مستعجل — عيادة مفتوحة حتى 4 مساءً",
  },
  {
    id: "ord-7",
    orderNumber: "SK-334871",
    customerId: "cust-5",
    customerName: "د. سارة القحطاني",
    customerType: "doctor",
    ...
    address: "حي العزيزية",
    items: [
      { productId: "prod-8", productName: "Endo File K-File #25", quantity: 2, price: 145, sku: "END-KF-25-6" },
    ],
    total: 290,
    status: "accepted",
    createdAt: "2026-06-29T07:45:00",
    deliveryAgentId: "agent-1",
    deliveryAgentName: "محمد الشهري",
    deliveryMethod: "standard",
    distanceKm: 9.3,
    etaMinutes: 28,
  },
...
export const driverNotifications: DriverNotification[] = [
  {
    ...
    type: "new_order",
    title: "طلب جديد",
    message: "تم تعيين طلب SK-391204 إليك — عيادة د. أحمد العتيبي",
    time: "منذ 5 دقائق",
    read: false,
    orderNumber: "SK-391204",
  },
  {
    ...
    message: "تم تحديث عنوان التوصيل للطلب SK-482917",
    time: "منذ 20 دقيقة",
    read: false,
    orderNumber: "SK-482917",
  },
  {
    ...
    title: "العميل اتصل بك",
    message: "عيادة الابتسامة الذهبية حاولت التواصل معك",
    time: "منذ ساعة",
    read: true,
    orderNumber: "SK-482917",
  },
  {
    ...
    message: "تم تأكيد تسليم الطلب SK-891234 بنجاح",
    time: "منذ يومين",
    read: true,
    orderNumber: "SK-891234",
  },
  {
    ...
    message: "تم إلغاء طلب SK-110293 من قبل الإدارة",
    time: "منذ 3 أيام",
    read: true,
  },
];

export const deliveryManagementStats = {
  totalDrivers: deliveryAgents.length,
  deliveringOrders: 3,
  onlineDrivers: deliveryAgents.filter((a) => a.isOnline).length,
...
export const deliveryTimelineSteps: {
  status: string;
  label: string;
}[] = [
  { status: "new", label: "تم إنشاء الطلب" },
  { status: "assigned", label: "تمت الموافقة" },
  { status: "preparing", label: "جاري التجهيز" },
  { status: "picked_up", label: "تم استلامه من المستودع" },
  { status: "out_for_delivery", label: "في الطريق" },
  { status: "arrived", label: "تم الوصول" },
